...
if __name__ == '__main__':
    ...
    #with open('accuracy_hidden_units.csv', 'w', newline='') as f:
    #    write = csv.writer(f)
    ...
    plt.plot(range(1,num_epochs+1), train_acc, label='Train accuracies')
    plt.plot(range(1,num_epochs+1), val_acc, label='Test accuracies')
    plt.legend()
    plt.grid()
